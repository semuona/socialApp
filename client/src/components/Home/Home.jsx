      ...
      {posts?.map((item, idx) => (
        <div className="postContainer" key={item?._id}>
...

          {
                    showComments[idx] ? item.comments.map((comment, cidx)=> <div style={{display: 'flex', justifyContent: 'space-between'}}>
                        ...
                        <div className="editToolsContainer">
                          ...
                          <DeleteIcon onClick={() => handleDeleteComment(idx, cidx)}/>
                        </div>
                    </div>)
                    : null
                }
          <div style={{display: "flex", justifyContent:"space-between", marginTop:"10px"}}>
                ...
                <textarea style={{width:"300px", padding:"5px", marginRight:"10px"}}placeholder="Type your comment" value={comments[idx]} onChange={e => handleCommentChange(e.target.value, idx)}/>
                <Button
          variant="contained"
          endIcon={<SendIcon />}
      ...
      <div className="sideProfileContainer">
        ...
        }
        {
            ...
            <Modal 
                ...
                onChange={e => setCommentToUpdate({...commentToUpdate, text: e.target.value}) }
            />
...
function Modal({save, close, value, onChange}) {
  ...
  <textarea style={{width:"300px", padding:"5px"}} value={value} onChange={onChange}/>
  <p>
